  ...
  <section class="text-gray-700 body-font">
    <div class="container px-5 py-24 mx-auto">
      <div class="flex flex-wrap -m-4">
        <div v-scroll-reveal="{ delay: 200 }" class="p-4 md:w-1/3">
          <div
        ...
        <div v-scroll-reveal="{ delay: 250 }" class="p-4 md:w-1/3">
          <div
            class="h-full border-2 border-gray-200 rounded-lg overflow-hidden"
          >
            <img
        ...
        <div v-scroll-reveal="{ delay: 300 }" class="p-4 md:w-1/3">
          <div
            class="h-full border-2 border-gray-200 rounded-lg overflow-hidden"
          >
            <img
        ...
        <div v-scroll-reveal="{ delay: 350 }" class="p-4 md:w-1/3">
          <div
            class="h-full border-2 border-gray-200 rounded-lg overflow-hidden"
          >
            <img
        ...
        <div v-scroll-reveal="{ delay: 400 }" class="p-4 md:w-1/3">
          <div
            class="h-full border-2 border-gray-200 rounded-lg overflow-hidden"
          >
            <img
        ...
        <div v-scroll-reveal="{ delay: 450 }" class="p-4 md:w-1/3">
          <div
            class="h-full border-2 border-gray-200 rounded-lg overflow-hidden"
          >
            <img
